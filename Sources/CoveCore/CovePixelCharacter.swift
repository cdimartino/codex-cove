...
public struct CovePixelCharacter: Codable, Equatable, Hashable, Sendable, Identifiable {
    ...
    public static func assigned(to identity: String) -> CovePixelCharacter {
